...
- `rules/` — modular rule files loaded automatically (code-search-tooling, claude-mem-restart, context7, csharp-style, dotfiles-setup, git-commit-checkpoints, git-write-consent, proactive-guidance)
