...
- `rules/` — modular rule files loaded automatically (ast-grep-preference, claude-mem-restart, context7, csharp-style, dotfiles-setup, git-commit-checkpoints, git-write-consent, proactive-guidance)
